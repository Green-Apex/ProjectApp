...
public class AddPm extends BaseActivity implements OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.tvSave_EditProfile:
                if (isValid()) {
                    ...
                    addUserRequest.setRole(Constants.PM);
                    addUserRequest.setContactNo(etContact_EditProfile.getText().toString());
    ...
    public boolean isValid() {
        ...
        if (etFirstname_EditProfile.getText().length() <= 0) {
            Toast.makeText(AddPm.this, "Please enter First name", Toast.LENGTH_SHORT).show();
        ...
        if (etLastname_EditProfile.getText().length() <= 0) {
            Toast.makeText(AddPm.this, "Please enter Last name", Toast.LENGTH_SHORT).show();
            etLastname_EditProfile.requestFocus();
            isSuccess = false;
            return isSuccess;
        }
        if (etEmail_EditProfile.getText().length() <= 0) {
            Toast.makeText(AddPm.this, "Please enter Email", Toast.LENGTH_SHORT).show();
