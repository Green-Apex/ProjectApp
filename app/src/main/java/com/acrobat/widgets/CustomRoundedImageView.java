...
public class CustomRoundedImageView extends ImageView {
    ...
    private ColorStateList mBorderColor = ColorStateList
            .valueOf(CustomRoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public CustomRoundedImageView(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CustomRoundedImageView, defStyle, 0);

        int index = a.getInt(
                R.styleable.CustomRoundedImageView_android_scaleType, 1);
        if (index >= 0) {
        ...
        mCornerRadius = a.getDimensionPixelSize(
                R.styleable.CustomRoundedImageView_corner_radius, 360);
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.CustomRoundedImageView_border_width, 2);
        ...
        mBorderColor = a
                .getColorStateList(R.styleable.CustomRoundedImageView_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(Color.WHITE);
        }

        mRoundBackground = a.getBoolean(
                R.styleable.CustomRoundedImageView_round_background, false);
        mOval = a.getBoolean(R.styleable.CustomRoundedImageView_is_oval, false);
    ...
    private void updateAttrs(Drawable drawable, boolean background) {
        ...
        if (drawable instanceof CustomRoundedDrawable) {
            ((CustomRoundedDrawable) drawable)
    ...
    public void setBackgroundDrawable(Drawable background) {
        mBackgroundDrawable = CustomRoundedDrawable.fromDrawable(background);
        updateBackgroundDrawableAttrs();
