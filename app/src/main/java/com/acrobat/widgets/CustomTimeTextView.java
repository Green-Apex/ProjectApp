...
public class CustomTimeTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomTimeTextView, 0, 0);
        try {
            mText = a.getString(R.styleable.CustomTimeTextView_reference_time);
            mPrefix = a.getString(R.styleable.CustomTimeTextView_relative_time_prefix);
            mSuffix = a.getString(R.styleable.CustomTimeTextView_relative_time_suffix);
     ...
     *
     * @param prefix Example: [prefix] in XX minutes
     */
     ...
     *
     * @param suffix Example: in XX minutes [suffix]
     */
     ...
     *
     * @param referenceTime The timestamp (in milliseconds since epoch) that will be the
    ...
    private CharSequence getRelativeTimeDisplayString() {
        ...
        return (difference >= 0 && difference <= DateUtils.MINUTE_IN_MILLIS) ? "Just now" : DateUtils
