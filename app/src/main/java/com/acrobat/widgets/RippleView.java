...
public class RippleView extends Button {
    ...
    public RippleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_MyRippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleView_MyAlphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleView_hover1, mHover);
        setCustomFont(context, attrs);
        a.recycle();
    }
